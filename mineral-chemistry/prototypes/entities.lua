...
{
    {
        ...
        {
            {
            filename = "__mineral-chemistry__/graphics/entity/froth-floatator.png",
            width = 220,
            height = 292,
            frame_count = 24,
            line_length = 12,
...

    {
        ...
        graphics_set =
        {
          animation =
          {
            ...
            {
              {
                filename = "__mineral-chemistry__/graphics/entity/blast-furnace/blast-furnace.png",
                priority = "high",
                width = 171,
                height = 174,
              ...
              {
                filename = "__mineral-chemistry__/graphics/entity/blast-furnace/blast-furnace-shadow.png",
                priority = "high",
                width = 277,
                height = 85,
                draw_as_shadow = true,
          ...
          {
            {
              ...
              animation =
              {
                filename = "__mineral-chemistry__/graphics/entity/blast-furnace/blast-furnace-fire.png",
                priority = "high",
                line_length = 8,
                width = 57,
                height = 81,
            ...
            },
            {
              ...
              animation =
              {
                filename = "__mineral-chemistry__/graphics/entity/blast-furnace/blast-furnace-glow.png",
                priority = "high",
                width = 60,
                height = 43,
                draw_as_glow = true,
            ...
            },
            {
              ...
              animation =
              {
                filename = "__mineral-chemistry__/graphics/entity/blast-furnace/blast-furnace-working.png",
                priority = "high",
                line_length = 1,
                width = 128,
                height = 150,
            ...
            },
            {
              ...
              animation =
              {
                filename = "__mineral-chemistry__/graphics/entity/blast-furnace/blast-furnace-ground-light.png",
                priority = "high",
                line_length = 1,
                width = 152,
                height = 126,
          ...
          water_reflection =
          {
            pictures =
            {
              filename = "__mineral-chemistry__/graphics/entity/blast-furnace/blast-furnace-reflection.png",
              priority = "extra-high",
              width = 20,
              height = 24,
...

    {
        ...
        energy_usage = "1700kW",
        graphics_set = require("__mineral-chemistry__.prototypes.entity.cryogenic-plant-pictures").graphics_set,
        ...
        fluid_boxes =
        {
          ...
          {
            production_type = "input",
            pipe_picture =  require("__mineral-chemistry__.prototypes.entity.cryogenic-plant-pictures").pipe_picture,
            pipe_picture_frozen =  require("__mineral-chemistry__.prototypes.entity.cryogenic-plant-pictures").pipe_picture_frozen,
