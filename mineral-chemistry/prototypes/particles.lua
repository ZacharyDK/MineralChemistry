...
local ps_particle_animations = require("__mineral-chemistry__/prototypes/particle-animations")
...
local particles =
{
  ...
  make_particle
  {
    name = "terra-asteroid-chunk-particle-small",
    life_time = 25,
    pictures = ps_particle_animations.get_terra_asteroid_particle_small_pictures(),
    shadows = ps_particle_animations.get_terra_asteroid_particle_small_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0)}),
  ...
  make_particle
  {
    name = "terra-asteroid-chunk-particle-medium",
    life_time = 45,
    pictures = ps_particle_animations.get_terra_asteroid_particle_medium_pictures(),
    shadows = ps_particle_animations.get_terra_asteroid_particle_medium_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0)}),
    regular_trigger_effect = nil,
    ended_in_water_trigger_effect = default_ended_in_water_trigger_effect(),
    render_layer_when_on_ground = "lower-object-above-shadow"
  },
  ...
  make_particle
  {
    name = "terra-asteroid-particle-top-small",
    life_time = 82,
    pictures = ps_particle_animations.get_terra_asteroid_particle_top_small_pictures(),
    shadows = ps_particle_animations.get_terra_asteroid_particle_top_small_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0)}),
    regular_trigger_effect = nil,
    ended_in_water_trigger_effect = default_ended_in_water_trigger_effect(),
  ...
  make_particle
  {
    name = "terra-asteroid-particle-top-big",
    life_time = 78,
    pictures = ps_particle_animations.get_terra_asteroid_particle_top_big_pictures(),
    shadows = ps_particle_animations.get_terra_asteroid_particle_top_big_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0)}),
    regular_trigger_effect = nil,
    ended_in_water_trigger_effect = default_ended_in_water_trigger_effect(),
    render_layer = "air-object",
    render_layer_when_on_ground = "lower-object-above-shadow",
  ...
  make_particle
  {
    name = "terra-asteroid-particle-top-huge",
    life_time = 64,
    pictures = ps_particle_animations.get_terra_asteroid_particle_top_big_pictures({scale = 1}),
    shadows = ps_particle_animations.get_terra_asteroid_particle_top_big_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0)}),
    regular_trigger_effect = nil,
    ended_in_water_trigger_effect = default_ended_in_water_trigger_effect(),
    render_layer = "air-object",
  ...
  make_particle
  {
    name = "terra-asteroid-particle-small",
    life_time = 120,
    pictures = ps_particle_animations.get_terra_asteroid_particle_small_pictures(),
    shadows = ps_particle_animations.get_terra_asteroid_particle_small_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0)}),
    regular_trigger_effect = nil,
  ...
  make_particle
  {
    name = "terra-asteroid-particle-medium",
    life_time = 200,
    pictures = ps_particle_animations.get_terra_asteroid_particle_medium_pictures(),
    shadows = ps_particle_animations.get_terra_asteroid_particle_medium_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0)}),
    regular_trigger_effect = nil,
  ...
  make_particle
  {
    name = "terra-asteroid-particle-big",
    life_time = 160,
    pictures = ps_particle_animations.get_terra_asteroid_particle_big_pictures(),
    shadows = ps_particle_animations.get_terra_asteroid_particle_big_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0)}),
    regular_trigger_effect = nil,
    ended_in_water_trigger_effect = default_ended_in_water_trigger_effect(),
    render_layer_when_on_ground = "lower-object-above-shadow",
    movement_modifier = 0.1
