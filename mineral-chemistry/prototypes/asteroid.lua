--Taken from space-age/prototypes/entity/asteroid
...
local function asteroid_variation(asteroid_type, suffix, scale, size)
  return
  {
    color_texture =
    {
      filename = "__mineral-chemistry__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-colour-" .. suffix .. ".png",
    ...
    normal_map =
    {
      filename = "__mineral-chemistry__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-normal-" .. suffix .. ".png",
      premul_alpha = false,
      size = sizes_resolution[size][1],
      scale = scale
    },
    ...
    roughness_map =
    {
      filename = "__mineral-chemistry__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-roughness-" .. suffix .. ".png",
      premul_alpha = false,
      size = sizes_resolution[size][1],
      scale = scale
    }
    ...
    {
      {
        ...
        icon = "__mineral-chemistry__/graphics/icons/"..asteroid_name..".png",
        icon_size = 64,
...
data.raw["asteroid-chunk"]["terra-asteroid-chunk"].graphics_set.lights[2] = { color = {0.7,0.7,0.7}, direction = {-1,-45,0.1} }
